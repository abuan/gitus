...
INSERT INTO `Project` VALUES (1,"Default_Project1",datetime('now', 'localtime'),"Projet par defaut utilise pour les tests","auteur 1");
INSERT INTO `Project` VALUES (2,"Default_Project2",datetime('now', 'localtime'),"Projet par defaut utilise pour les tests","auteur 2");
INSERT INTO `UserStory` VALUES (1,"Default_US1",datetime('now', 'localtime'),"User Story par defaut utilise pour les tests","auteur 1",5);
