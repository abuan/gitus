...
// SetStatusOperation will change the status of a story
...
func Open(s Interface, author identity.Interface, unixTime int64) (*SetStatusOperation, error) {
...
// Convenience function to apply the operation
func Close(s Interface, author identity.Interface, unixTime int64) (*SetStatusOperation, error) {
